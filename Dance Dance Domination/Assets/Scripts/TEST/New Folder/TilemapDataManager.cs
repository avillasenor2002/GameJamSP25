...
public class TilemapDataManager : MonoBehaviour
{
    ...
    public TileDataScriptableObject abovegroundTileDataSO; // ScriptableObject for aboveground tiles
    public TileDataScriptableObject belowgroundTileDataSO; // ScriptableObject for belowground tiles
    ...
    public List<TileInfo> abovegroundTilePalette; // Aboveground tile sprites and names
    public List<TileInfo> belowgroundTilePalette; // Belowground tile sprites and names
    ...
    private void Start()
    {
        ...
        string levelSequenceU = "112222222114060606031400000003140006000314006600031400000003140606060314060606031155555551";
        undertileDataSO.PopulateTileDataFromSequence(levelSequenceU);
        string levelSequenceA = "356525656536060606063500000005360000006035000000503600000060350505050536060606063777777777";
